...
public class LuaFramework_NetworkManagerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("HandleNetMsg", HandleNetMsg);
	...
	static int SendConnect(IntPtr L)
	{
		try
		{
			...
			SocketClient.ServerType arg2 = (SocketClient.ServerType)ToLua.CheckObject(L, 4, typeof(SocketClient.ServerType));
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int HandleNetMsg(IntPtr L)
	{
		try
		{
