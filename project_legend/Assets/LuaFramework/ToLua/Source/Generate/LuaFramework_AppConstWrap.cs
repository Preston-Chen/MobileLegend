...
public class LuaFramework_AppConstWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("isDevelop", get_isDevelop, set_isDevelop);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_isDevelop(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushboolean(L, LuaFramework.AppConst.isDevelop);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int get_AssetDirname(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, LuaFramework.AppConst.AssetDirname);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_isDevelop(IntPtr L)
	{
		try
		{
			bool arg0 = LuaDLL.luaL_checkboolean(L, 2);
			LuaFramework.AppConst.isDevelop = arg0;
			return 0;
		}
		catch (Exception e)
		{
