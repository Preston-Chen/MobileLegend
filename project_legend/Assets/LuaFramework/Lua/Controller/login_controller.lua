...
local function formatnumberthousands()
	print("<color=orange>".."funciton生效".."</color>")
end

function login_controller:useformatnumberthousands()
    formatnumberthousands()
end 

function login_controller:destroyformatnumberthousands()
    formatnumberthousands = nil 
end 
